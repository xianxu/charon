...
- [charon.md](charon.md) — Charon credential proxy: architecture, components, design decisions
- [security-audit.md](security-audit.md) — `charon-security`: Mac hygiene auditor for agentic-coding setups
- [workflow/](workflow/) — Ariadne workflow system (inherited base layer)
